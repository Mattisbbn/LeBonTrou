<x-layouts.guest>
    ...
    <main class="w-8/10 mx-auto">
        <div class="bg-gradient-to-r from-void-950 to-deep-950 text-white rounded-3xl p-8 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="bg-white bg-opacity-10 rounded-xl p-4">
                        ...
                        <div class="text-2xl font-bold" contenteditable="false">0.00042 HLC</div>
                        <div class="text-green-400 text-sm" contenteditable="false">+12.5% (24h)</div>
                    </div>
                    <div class="bg-white bg-opacity-10 rounded-xl p-4">
                    ...
                    <div class="bg-white bg-opacity-10 rounded-xl p-4">
                        ...
                        <div class="text-2xl font-bold" contenteditable="false">1.3M HLC</div>
